...
import { cn, getTransactionStatus, formatAmount, removeSpecialCharacters, formatDateTime } from "@/lib/utils";
...
// Formats the category section to uncapitalize every letter besides the first and removes underscores
